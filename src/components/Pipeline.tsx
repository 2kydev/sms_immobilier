        ...
        <Card>
          <CardContent className="pt-6">
            <div className="text-2xl font-bold text-green-600">
              {transactions.reduce((sum, t) => sum + t.valeur, 0).toLocaleString()}€
            </div>
        ...
        <Card>
          <CardContent className="pt-6">
            <div className="text-2xl font-bold text-blue-600">
              {Math.round(transactions.reduce((sum, t) => sum + (t.valeur * t.probabilite / 100), 0)).toLocaleString()}€
            </div>
          ...
          {selectedTransaction && (
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="space-y-2">
                ...
                <Input id="clientPrenom" defaultValue={selectedTransaction.clientPrenom} />
              </div>

              <div className="space-y-2">
                <Label htmlFor="clientNom">Nom du client</Label>
                <Input id="clientNom" defaultValue={selectedTransaction.clientNom} />
              </div>

              <div className="space-y-2">
                <Label htmlFor="clientTelephone">Téléphone</Label>
                <Input id="clientTelephone" defaultValue={selectedTransaction.clientTelephone} />
              </div>
              ...
              <div className="space-y-2 md:col-span-2">
                ...
                <Input id="propriete" defaultValue={selectedTransaction.propriete} />
              </div>

              <div className="space-y-2">
                <Label htmlFor="valeur">Valeur (€)</Label>
                <Input id="valeur" type="number" defaultValue={selectedTransaction.valeur} />
              </div>

              <div className="space-y-2">
                <Label htmlFor="probabilite">Probabilité (%)</Label>
                <Input id="probabilite" type="number" min="0" max="100" defaultValue={selectedTransaction.probabilite} />
              </div>
