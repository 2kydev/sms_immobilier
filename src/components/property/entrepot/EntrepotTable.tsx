  ...
  return (
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
        <Card>
          <CardHeader>
            <CardTitle>Total des entrepôts</CardTitle>
            <CardDescription>Nombre total d’entrepôts en vente</CardDescription>
          </CardHeader>
          <CardContent>
      ...
      <Card>
        ...
        <CardContent>
          {loading ? (
            ...
            <div className="py-8 text-center text-muted-foreground">Aucun entrepôt trouvé</div>
          ) : (
            <Table>
              <TableHeader>
                <TableRow>
